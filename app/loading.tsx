export default function Loading() {
  return <div role="status" aria-label="Loading PugGift" className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#202225]">
    <div className="pug-loading-mascot relative flex h-28 w-28 items-center justify-center">
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/images/puggift-mark-v7.webp" alt="" className="h-full w-full object-contain" />
    </div>
