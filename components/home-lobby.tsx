  ...
  return <section className="flex w-full flex-col gap-6">
    ...
    <div className="mx-auto flex w-full max-w-[584px] flex-col gap-3 px-3">
      ...
      <div className="flex flex-col gap-3">
        {freeCaseSlug && <ModeRow href={`/case/${freeCaseSlug}`} title="Free" subtitle="Free case" color="#343946" image="/images/menu/gift-v6.svg" />}
        ...
        <ModeRow href="/crash" title="Crash" subtitle="Live rounds" color="#081122" image="/images/menu/rocket-v6.svg" />
        <ModeRow href="/battles" title="PvP" color="#ae713a" image="/images/menu/swords-v6.svg" />
        <ModeRow href="/mines" title="Mines" subtitle="Find the safe cells" color="#b71d37" image="/images/menu/bomb-v6.svg" />
        <ModeRow href="/dice" title="Dice" subtitle="Choose your number" color="#138256" image="/images/menu/dice-v6.svg" />
