...
export function HomeLobby({ online }: { online: number }) {
  ...
  return <section className="mx-auto flex w-full max-w-[560px] flex-col gap-3 px-3 md:px-4">
    ...
    <Link href="/crash" className="group relative mt-1 aspect-[2.45/1] min-h-[150px] overflow-hidden rounded-[30px] bg-[#091327] ring-1 ring-white/10">
      ...
      <span className="absolute bottom-4 left-4 flex items-center gap-2 rounded-2xl bg-amber-300 px-4 py-2.5 text-xs font-black text-[#241800] shadow-[0_8px_24px_rgba(252,211,77,.22)]"><Clock3 className="h-4 w-4" />Техработы</span>
    </Link>
    ...
    <div className="flex flex-col gap-3">
      ...
      <GameRow href="/crash" title="Краш" subtitle="Временно закрыт на технические работы" art="/images/puggift-crash-card-v2.webp" tone="from-[#061738] via-[#0d3477] to-[#071127]" badge="ТЕХРАБОТЫ" />
