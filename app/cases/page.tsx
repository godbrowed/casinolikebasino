  ...
  return <>
    ...
    <main className="mx-auto w-full max-w-[980px] px-3 pb-8 pt-5 md:px-5">
      <div className="mb-4 flex items-end justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-1.5 rounded-full border border-emerald-400/20 bg-emerald-400/8 px-2.5 py-1.5 text-[10px] font-bold text-emerald-300"><ShieldCheck className="h-3.5 w-3.5" />90% RTP</div>
      </div>
