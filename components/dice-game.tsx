...
export function DiceGame() {
  ...
  return <main className="game-surface game-surface--upgrade relative mx-auto min-h-[calc(100dvh-64px)] w-full max-w-[980px] overflow-hidden px-3 pb-[calc(7rem+var(--tg-content-safe-area-inset-bottom,0px))] pt-3 text-white md:px-5 md:pt-5">
    ...
    <header className="relative flex items-center gap-4 px-2 py-3"><Dices className="h-10 w-10 shrink-0 text-violet-300" strokeWidth={1.6} /><div><h1 className="font-display text-3xl font-bold">Dice</h1><p className="mt-1 text-sm text-white/50">Choose a target. Roll your number.</p></div></header>
