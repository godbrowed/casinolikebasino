...
const strings = { en: { games:"Games", cases:"Cases", battles:"Battles", crash:"Crash", upgrade:"Upgrade", profile:"Profile", guest:"Guest", demo:"demo" }, ru: { games:"Игры", cases:"Кейсы", battles:"Битвы", crash:"Краш", upgrade:"Апгрейд", profile:"Профиль", guest:"Гость", demo:"демо" } } as const
